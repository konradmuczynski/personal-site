...
const work = [
  {
    ...
    highlights: [
      ...
      'Utilized BigQuery to analyze large-scale datasets across multiple business units, identifying trends, fixing bugs, and modifying existing queries to make them more efficient.',
      'Collaborated with the engineering team(s) to create and implement new data pipelines using SQL and Python.',
      ...
      'Implemented Agile methodologies, introduced structured weekly sprints, and set up task tracking and project management in JIRA to improve team collaboration.',
      'Established Confluence as a documentation and knowledge-sharing hub to support onboarding and general stakeholder knowledge sharing.',
      ...
      'Mentored and onboarded two new analysts by walking them through data models, business processes, and internal tools used daily.',
    ],
  },
  {
  ...
  },
  {
    ...
    highlights: [
      ...
      'Conducted small-scale A/B tests on selected user groups, experimenting with small changes such as moving the CTA button to different places on web/mobile pages.',
  ...
  },
  {
    ...
    highlights: [
      'Analyzed customer behavior, transaction patterns, and game performance to identify trends and opportunities for business growth.',
  ...
  },
  {
    ...
    highlights: [
      'Developed and optimized SQL queries to extract and analyze sales data across 15+ countries where the Sinsay brand was present, providing actionable insights to support business decisions.',
      'Conducted small-scale A/B tests on selected user groups, experimenting with changes such as price font and color to assess impact.',
      ...
      'Performed data analysis using Pandas to extract insights and presented findings to management through detailed Excel reports and presentations.',
    ],
  },
  {
    name: 'Argos',
    ...
    highlights: [
      'Provided customer service by assisting customers with purchases.',
      'Restocked inventory in the stockroom to optimal levels.',
      'Trained new employees in a high-turnover environment.',
    ],
  },
  {
    name: 'Lushurious',
  ...
  },
  {
    ...
    highlights: [
      'Provided customer service by helping customers find products and directing them to the right location.',
      'Restocked shelves to optimal levels.',
      'Ensured the store remained presentable and clean for customers.',
    ],
  },
  {
    name: 'Starbucks',
